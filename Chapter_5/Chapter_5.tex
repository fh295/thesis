...
\vspace{5pt}\noindent{\bf Bottom-Up Methods} We train {\bf CBOW} and {\bf SkipGram} word embeddings \cite{mikolov2013distributed} on the Books corpus, and compose by elementwise addition as proposed by \cite{mitchell2010composition}.\footnote{We also tried multiplication but this gave very poor results.} 
